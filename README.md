...
pissgrind is a fork of [Chora](https://github.com/CraftWorksMC/Chora) by CraftWorksMC, heavily modified and rebranded for private use. It connects to a self hosted Navidrome server and provides streamlined music streaming with a custom theme and many new features. Currently there are over 10'000 songs from 1000+ albums by 550+ artists available to stream for free.
